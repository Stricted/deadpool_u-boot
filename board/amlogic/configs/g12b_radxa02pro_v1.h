...
#ifndef __G12B_RADXA02PRO_V1_H__
#define __G12B_RADXA02PRO_V1_H__
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read usid ${loadaddr} str; then "\
                    ...
                    "setenv serial ${usid};"\
                "else "\
                    "setenv bootargs ${bootargs} androidboot.serialno=1234567895;"\
                    "setenv serial 1234567895;"\
                "fi;"\
...
#define CONFIG_DEVICE_PRODUCT	"radxa02pro"
