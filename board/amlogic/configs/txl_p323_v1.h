...
#define CONFIG_VDDEE_SLEEP_VOLTAGE	 1000		// voltage for suspend
...
/* ddr */
#define CONFIG_DDR_SIZE					1536 //MB //0 means ddr size auto-detect
...
#define CONFIG_DEVICE_PRODUCT	"p323"
