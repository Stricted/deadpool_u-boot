...
#ifndef __SM1_RADXA02_V1_H__
#define __SM1_RADXA02_V1_H__
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read usid ${loadaddr} str; then "\
                    ...
                    "setenv serial ${usid};"\
                "else "\
                    "setenv bootargs ${bootargs} androidboot.serialno=1234567891;"\
...
#define CONFIG_DEVICE_PRODUCT	"radxa02"
