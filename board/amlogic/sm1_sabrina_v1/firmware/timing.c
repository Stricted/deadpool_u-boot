...
bl2_reg_t __bl2_reg[] = {
	...
	{PAD_PULL_UP_EN_REG4,      0,                 ((1<< 8)| (1 << 7)| (1 << 3)),   0, BL2_INIT_STAGE_1, 0},    /* [3] GPIOZ_3; [7] GPIOZ_7; [8] GPIOZ_8 */
	{AO_RTI_PULL_UP_EN_REG,    0,                 (1<< 10),      0, BL2_INIT_STAGE_1, 0},     /* [10] GPIOAO_10 */
	/* Set the GPIO direction to Input */
	{PREG_PAD_GPIO1_EN_N,      (1<< 7), (1<< 7),   0, BL2_INIT_STAGE_1, 0},    /* [7] GPIOC_7 */
	{PREG_PAD_GPIO3_EN_N,      ((1<< 8)| (1 << 7)| (1 <<6)), ((1<< 8)| (1 << 7)| (1 << 6)),   0, BL2_INIT_STAGE_1, 0},    /* [6] GPIOH_6; [7] GPIOH_7; [8] GPIOH_8 */
	{PREG_PAD_GPIO4_EN_N,      ((1<< 8)| (1 << 7)| (1 << 3)), ((1<< 8)| (1 << 7)| (1 << 3)),   0, BL2_INIT_STAGE_1, 0},    /* [3] GPIOZ_3; [7] GPIOZ_7; [8] GPIOZ_8 */
	{AO_GPIO_O_EN_N,           (1 << 10),                     (1 << 10),     0, BL2_INIT_STAGE_1, 0},     /* [10] GPIOAO_10 */
	/* Set the pinmux to GPIO */
	{PERIPHS_PIN_MUX_6,        0,                 ((0xf<< 12)| (0xf <<28)),        0, BL2_INIT_STAGE_1, 0},    /* [15:12] GPIOZ_3; [31:28] GPIOZ_7 */
	{PERIPHS_PIN_MUX_7,        0,                 0xf,           0, BL2_INIT_STAGE_1, 0},     /* [3:0] GPIOAO_8 */
	{PERIPHS_PIN_MUX_9,        0,                 (0xf << 28),           0, BL2_INIT_STAGE_1, 0},     /* [31:28] GPIOC_7 */
	{PERIPHS_PIN_MUX_B,        0,                 ((0xf<< 20)|(0xf<< 24)| (0xf <<28)),        0, BL2_INIT_STAGE_1, 0},    /* [23:20] GPIOH_5; [27:24] GPIOH_6; [31:28] GPIOH_7 */
	{PERIPHS_PIN_MUX_C,        0,                 0xf,           0, BL2_INIT_STAGE_1, 0},    /* [3:0] GPIOH_8 */
	{AO_RTI_PINMUX_REG1,       0,                 (0xf << 8),    0, BL2_INIT_STAGE_1, 0},     /* [11:8] GPIOAO_10 */
};
